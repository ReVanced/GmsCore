...
public class RomSpoofSignatureChecks implements SelfCheckGroup {
    ...
    private boolean addSystemSpoofsSignature(Context context, ResultCollector collector) {
        ...
        boolean spoofsSignature = GOOGLE_SERVICES_PACKAGE_SIGNATURE_SHA1.equals(PackageUtils.firstSignatureDigest(context, Constants.GMS_PACKAGE_NAME, true)) &&
                GOOGLE_SERVICES_PACKAGE_SIGNATURE_SHA1.equals(PackageUtils.firstSignatureDigest(context, Constants.GMS_PACKAGE_NAME, false));
